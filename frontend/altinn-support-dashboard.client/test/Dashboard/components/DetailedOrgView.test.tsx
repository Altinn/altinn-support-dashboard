...
vi.mock("../../../src/components/Dashboard/components/ERRolesTable", () => ({
  default: ({ selectedOrg }: { selectedOrg: SelectedOrg }) => (
...
vi.mock("../../../src/components/Dashboard/components/contacts/ContactsSearchBar", () => ({
    //eslint-disable-next-line @typescript-eslint/no-explicit-any
...
vi.mock("../../../src/components/Dashboard/components/contacts/ContactsTable", () => ({
    //eslint-disable-next-line @typescript-eslint/no-explicit-any
...
vi.mock("../../../src/components/Dashboard/components/contacts/NotificationContactTable", () => ({
  //eslint-disable-next-line @typescript-eslint/no-explicit-any
...
describe('DetailedOrgView', () => {
    ...
    it('should render organization details when selectedOrg is provided', () => {
        ...
        expect(screen.getByText(`Org Nr: ${mockSelectedOrg.OrganizationNumber}`)).toBeInTheDocument();
    ...
    it('should render NotificationContactTable for notification addresses', () => {
        ...
        expect(screen.getByText('Varslingsadresser for virksomheten')).toBeInTheDocument();
    ...
    it('should render ERRolesTable', () => {
        ...
        expect(screen.getByText(`ERRolesTable: ${mockSelectedOrg.Name}`)).toBeInTheDocument();
    });
    ...
    it('should hide ContactsTable, ContactsSearchBar, ERRolesTable and NotificationContactTable when contact is selected', () => {
        ...
        expect(screen.queryByTestId('notification-table-phone')).not.toBeInTheDocument();
        expect(screen.queryByTestId('notification-table-email')).not.toBeInTheDocument();
    });
    ...
    it('should clear search and selected contact when selectedOrg changes', () => {
        const { rerender } = render(<DetailedOrgView selectedOrg={mockSelectedOrg} />);
        ...
        const searchInput = screen.getByPlaceholderText('Search');
        expect(searchInput).toHaveValue('');
        expect(screen.getByText(`Org Nr: ${newOrg.OrganizationNumber}`)).toBeInTheDocument();
