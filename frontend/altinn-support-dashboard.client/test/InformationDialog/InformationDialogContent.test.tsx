...
describe("InformationDialogContent", () => {
  it("should render correct paragraph text", () => {
    ...
    expect(
      screen.getByText(/Dette betyr at det er kunden som oppgir informasjon/i),
    ).toBeInTheDocument();
  });
  ...
  it("should render correct example with checkmark", () => {
    ...
    expect(
      screen.getByText(
        /Kunden sier adressen og du bekrefter eller avkrefter at den er riktig/i,
      ),
    ).toBeInTheDocument();
  ...
  it("should render incorrect example with xmark", () => {
    ...
    expect(
      screen.getByText(/Kunden spør og du leser opp adressen/i),
    ).toBeInTheDocument();
