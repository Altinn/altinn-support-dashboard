...
vi.mock(
  "../../src/components/InformationDialog/InformationDialogContent",
  () => ({
    default: () => {
      ...
      return React.createElement(
        "div",
        { "data-testid": "information-dialog-content" },
        "Mocked InformationDialogContent",
      );
    },
  }),
);
...
describe("InformationDialogBox", () => {
  it("should render dialog with correct heading", () => {
    ...
    expect(
      screen.getByText(
        /Dette verktøyet skal kun brukes til å bekrefte informasjon/i,
      ),
    ).toBeInTheDocument();
  });
  ...
  it("should render InformationDialogContent", () => {
    ...
    expect(
      screen.getByTestId("information-dialog-content"),
    ).toBeInTheDocument();
  });
