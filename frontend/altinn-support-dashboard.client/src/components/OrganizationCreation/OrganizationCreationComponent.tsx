...
const OrganizationCreationComponent: React.FC<OrganizationCreationProps> = ({
  environment,
}) => {
      ...
      {!hasValidToken && (
        ...
        >
          <Alert data-color="danger" style={{ marginBottom: "16px" }}>
            ...
            <Paragraph>
              For å kunne opprette organisasjoner i Altinn Studio må du sette
              opp et gyldig PAT-token og velge miljø.
            </Paragraph>
          </Alert>
