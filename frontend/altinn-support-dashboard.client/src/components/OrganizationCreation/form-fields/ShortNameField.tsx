...
export const ShortNameField: React.FC<ShortNameFieldProps> = ({
  ...
  const getStatusMessage = () => {
    ...
    if (nameExists === true) {
      return {
        text: `Organisasjonen '${value}' eksisterer allerede i Altinn Studio.`,
        color: "#D41E1E",
      }; // Red for exists
    }
    ...
    return {
      text: "2-5 tegn, små bokstaver/tall. Kan inneholde bindestrek (-)",
      color: "#6A6A6A",
    }; // Gray for default
  };
  ...
  return (
    <div>
      ...
      >
        ...
        <Tooltip
          content="Kortnavnet brukes i URL-er og andre steder hvor et kort, unikt navn er nødvendig. Må være mellom 2-5 tegn."
          placement="top"
        >
